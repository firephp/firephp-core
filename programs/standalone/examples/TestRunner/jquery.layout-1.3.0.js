 ...
 */
    ...
    var _create = function () {
        ...
        if (!getPane('center').length) {
            console.log( lang.errCenterPaneMissing );
            return null;
        }
 ...
 */
    ...
    var open = function (pane, slide, noAnimation, noAlert) {
        ...
        if (s.minSize > s.maxSize) { // INSUFFICIENT ROOM FOR PANE TO OPEN!
            ...
            if (!noAlert && o.noRoomToOpenTip) console.log(o.noRoomToOpenTip);
            return; // ABORT
        }
    ...
    */
    function getBtn(selector, pane, action) {
        ...
        if (!$E.length) // element not found
            console.log(lang.errButton + lang.selector +": "+ selector);
        else if (_c.borderPanes.indexOf(pane) == -1) // invalid 'pane' sepecified
            console.log(lang.errButton + lang.Pane.toLowerCase() +": "+ pane);
        else { // VALID
 ...
 */
    ...
    if (!$Container.length) {
        console.log( lang.errContainerMissing );
        return null;
    };
